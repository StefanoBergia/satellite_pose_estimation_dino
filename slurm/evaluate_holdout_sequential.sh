...
#SBATCH --job-name=eval_holdout_sequential
#SBATCH --mem=50GB
...
CHECKPOINT="outputs_self_training_incremental_sequential/final_model.pth"

echo "=== Holdout-chunk evaluation — incremental sequential ==="
python evaluate_robust.py --checkpoint "${CHECKPOINT}" \
    ...
    --output "outputs_self_training_incremental_sequential/results_holdout.txt"
